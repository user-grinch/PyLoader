...
PyObject* PyAddition::GetCarPointer(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::GetCharPointer(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::GetObjectPointer(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::GetCarHandle(PyObject* self, PyObject* args)
{
	int ptr;
...
PyObject* PyAddition::GetCharHandle(PyObject* self, PyObject* args)
{
	int ptr;
...
PyObject* PyAddition::GetObjectHandle(PyObject* self, PyObject* args)
{
	int ptr;
...
PyObject* PyAddition::IsOnMission(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::IsOnCutscene(PyObject* self, PyObject* args)
{
	return Py_BuildValue("i", CCutsceneMgr::ms_running);
}

PyObject* PyAddition::GetLargestGangIdInZone(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::GetClosestVehicle(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::GetClosestPed(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::GetTargetMarkerCoords(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::GetVehicleNumberOfGears(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::GetVehicleCurrentGear(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::IsVehicleSirenOn(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::IsVehicleEngineOn(PyObject* self, PyObject* args)
{
	int handle;
...
PyObject* PyAddition::SetVehicleEngineState(PyObject* self, PyObject* args)
{
	int handle, state;
...
PyObject* PyAddition::GetPlayerTargetedChar(PyObject* self, PyObject* args)
{
...
PyObject* PyAddition::GetVehicleModelName(PyObject* self, PyObject* args)
{
	int model;
...
PyObject* PyAddition::GetVehicleModelFromName(PyObject* self, PyObject* args)
{
	char* name;
