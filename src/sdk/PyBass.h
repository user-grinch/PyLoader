...
private:
    ...
    static inline PyMethodDef Methods[] =
    {
        ...
        {"load_audiostream", LoadAudioStream, METH_VARARGS},
        {"loop_audiostream", LoopAudioStream, METH_VARARGS},
        {"load_audiostream_with_3d_support", LoadAudioStreamWith3dSupport, METH_VARARGS},
